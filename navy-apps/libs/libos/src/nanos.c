...
intptr_t _syscall_(intptr_t type, intptr_t a0, intptr_t a1, intptr_t a2) {
  register intptr_t _gpr1 asm (GPR1) = type;    //register intptr_t _gpr1 asm ("eax") = type;    
  register intptr_t _gpr2 asm (GPR2) = a0;      //register intptr_t _gpr2 asm ("ebx") = a0;
  register intptr_t _gpr3 asm (GPR3) = a1;      //register intptr_t _gpr3 asm ("ecx") = a1;    
  register intptr_t _gpr4 asm (GPR4) = a2;      //register intptr_t _gpr4 asm ("edx") = a2;
  register intptr_t ret asm (GPRx);             //register intptr_t ret asm ("eax");   
...
int _execve(const char *fname, char * const argv[], char *const envp[]) {
  return _syscall_(SYS_execve,fname,0,0);
}
